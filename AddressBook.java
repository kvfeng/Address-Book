...
frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
         ...
         public void addWidgets()

            {
                    ...
                    JButton ViewContactList = new JButton("View AllContacts");
         ...
         public void actionPerformed(ActionEvent ae)
            {
                if(ae.getActionCommand() == "Add New Contact")
                    ...
                    {
                          JOptionPane.showMessageDialog(frame, "About Address Book: Created By Rahul ChouhanComputer Engg, IET-DAVV,Indore. Website:http://www.Rahul Chouhan.tk","About Address Book",JOptionPane.INFORMATION_MESSAGE);
...
ObjectOutputStream(fos);
                ...
                {
                      JOptionPane.showMessageDialog(newFrame, "Error OpeningData File: Could Not Save Contents.", "Error Opening Data File",JOptionPane.INFORMATION_MESSAGE);
                }
       ...
       public void SearchContacts()
           {
               ...
               JLabel label1 = new JLabel("Search Contacts by First Nameor Last Name or Both Spaced Via a Single Space:");
               topPane.add(label1);
...
"Entries Empty! Fill in the required entries to save Contact.", "EntriesEmpty", JOptionPane.INFORMATION_MESSAGE);
...
JOptionPane.showMessageDialog(newFrame, "Select a Contact first to deleteit.", "Select a Contact First", JOptionPane.INFORMATION_MESSAGE);
                             ...
                             else
                              {
                                    ...
                                    int n =
JOptionPane.showConfirmDialog(newFrame, "Are you sure you want to deletethe selected Contact?", "Are you sure?", JOptionPane.YES_NO_OPTION);
...
"Contact Found!", "Search Result!", JOptionPane.INFORMATION_MESSAGE);
                            ...
                            {
                               JOptionPane.showMessageDialog(newFrame, 
"NoSuch Contact Found!", "Search Result!", JOptionPane.INFORMATION_MESSAGE);
                            }
